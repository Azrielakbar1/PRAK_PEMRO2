...
public class Penjualan {
	...
	public Penjualan(int jumlah, double total_harga, Date tanggal, int pelanggan_id, int buku_id) {
		this.jumlah = jumlah;
	...
	public Penjualan(int penjualan_id, int jumlah, double total_harga, Date tanggal, int pelanggan_id, int buku_id) {
